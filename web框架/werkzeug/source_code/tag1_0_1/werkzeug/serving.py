...
class BaseWSGIServer(HTTPServer, object):
    ...
    def __init__(
        ...
        port,
        app,
        handler=None, # 请求数据处理的中间件,middleware
...
def make_server(
    ...
    threaded=False,
    processes=1,
    request_handler=None, # 处理请求数据的中间件,middleware
    passthrough_errors=False,
    ssl_context=None,
    fd=None,
):
...
def run_simple(
    ...
    threaded=False,
    processes=1,
    request_handler=None, # 处理请求数据中间件, middleware
    static_files=None,
    passthrough_errors=False,
    ssl_context=None,
):
    ...
    def inner():
        ...
        srv = make_server(
            ...
            threaded,
            processes,
            request_handler, #处理请求数据中间件, middleware
            passthrough_errors,
            ssl_context,
            fd=fd,
        )
